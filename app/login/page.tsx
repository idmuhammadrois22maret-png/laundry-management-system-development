    ...
    try {
      ...
      if (error) {
        if (error.message.includes('Email not confirmed')) {
          throw new Error('Email belum dikonfirmasi. Cek email Anda atau hubungi admin.')
        }
        throw error
      }
    ...
    <div className="flex min-h-svh flex-col lg:flex-row">
      ...
      <div className="relative flex flex-col justify-between px-8 py-10 lg:w-[60%] lg:px-14 lg:py-12 overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg">
          ...
          >
            Kelola bisnis laundry Anda — pelanggan, pesanan, pembayaran, dan laporan dari satu dashboard modern.
          </motion.p>
        </div>
        ...
        >
          &copy; {new Date().getFullYear()} Laundrio. All rights reserved.
        </motion.p>
      </div>
        ...
        >
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold tracking-tight">Laundrio</span>
            </div>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <Button type="button" variant="outline" className="w-full gap-2 h-11" disabled>
